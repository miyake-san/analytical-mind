...
simple: **give you a single place to discover other repositories full of awesome
references**, so you always know where to look next.

Every link below points to an external, open resource. Pick a track, follow the
...
```
                       ┌───────────────────────────┐
                       │   Foundations (shared)     │
                       │ Python · SQL · Git · Stats │
                       └────────────┬──────────────-┘
                                    │
          ┌───────────────┬────────-┴───────┬────────────────┐
          ▼               ▼                  ▼                ▼
   Data Analytics   Data Engineering   Data Science   ML Engineering
          │               │                  │                │
          └──────────────-┴────────┬─────────┴────────────────┘
                                    ▼
                             AI Engineering
                       (LLMs · RAG · Agents · GenAI)
```
...
3. **Bookmark one or two "Awesome lists"** for ongoing discovery.
4. **Start a study project** in parallel — see [`../projects`](../projects/README.md).
...
> **Note on links:** All entries point to external projects maintained by their
> respective owners. Stars and activity change over time; if you find a dead or
> stale link, please open a pull request to fix it.
